...
// <o0> PRODUCT_TYPE
// <o1> PRODUCT_DETAIL
#define PRODUCT_NAME 								"EF-NO-MODULE" 
#define PRODUCT_TYPE 								0xFF
#define PRODUCT_DETAIL 								0XFF
// </h>
...
#define DEF_DBG_I_PRINT                             0   
#define DISABLE_DBG_W	                            0
#define DEF_DBG_W_PRINT                             0  
#define DISABLE_DBG_E	                            0             
#define DEF_DBG_E_PRINT                             0

#define ENABLE_RECORDER								0
#define DEF_REC_DAT_FLG 	                        0
